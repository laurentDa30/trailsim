  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--color-bg)' }}>
      ...
      <div className="flex-1 flex flex-col lg:flex-row lg:items-start">
        ...
        <aside
          className="w-full lg:w-[440px] shrink-0 p-4 flex flex-col gap-3 border-t lg:border-t-0 lg:border-l lg:sticky lg:top-[52px] lg:max-h-[calc(100vh-52px)] lg:overflow-y-auto"
