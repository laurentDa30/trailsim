...
const TEMPLATE: { days: number; title: string; category: string }[] = [
  { days: 150, title: "Inscrire l'épreuve au calendrier de la fédération d'athlétisme (FFA)", category: "ADMINISTRATIF" },
  { days: 120, title: "Déclarer la manifestation en préfecture / mairie", category: "ADMINISTRATIF" },
  { days: 120, title: "Démarcher les partenaires et sponsors (dotations, dons, lots)", category: "COMMUNICATION" },
  ...
  { days: 90, title: "Réserver le chronométreur", category: "LOGISTIQUE" },
  { days: 90, title: "Mettre en place le site d'inscription en ligne des coureurs", category: "COMMUNICATION" },
  { days: 75, title: "Commander les médailles", category: "LOGISTIQUE" },
  { days: 75, title: "Commander les tee-shirts coureurs", category: "LOGISTIQUE" },
  ...
  { days: 60, title: "Préparer les lots finisher", category: "LOGISTIQUE" },
  { days: 60, title: "Préparer les lots d'inscription (dossards, goodies)", category: "LOGISTIQUE" },
  { days: 60, title: "Plan de communication (réseaux sociaux, presse locale)", category: "COMMUNICATION" },
  { days: 50, title: "Créer et imprimer les affiches et flyers", category: "COMMUNICATION" },
  { days: 45, title: "Commander dossards et ravitaillements", category: "LOGISTIQUE" },
  { days: 45, title: "Réserver le matériel (barrières, sono, tentes, signalétique)", category: "LOGISTIQUE" },
